...
#_(deftest document-returns-documentation-string-for-tiny-type-entity
    (is (= (document :age)
           (str
              "Age\n"
              "- has attributes:\n"
...
(deftest document-chararacteristics-returns-documentation-string-provided-characteristics
  (is (= (document-characteristics ['(of-type Integer) '(never :null :negative)])
         (str
           "- of integer type\n"
           "- never null or negative"))))

(deftest document-chararacteristics-returns-documentation-string-provided-characteristic
  (is (= (document-characteristics ['(of-type Integer)])
         (str "- of integer type"))))
